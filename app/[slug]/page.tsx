...
const STATIC_PAGES: Record<string, InfoPage> = {
  about: {
    ...
    cards: [
      { title: 'Student Workspace', description: 'Học khóa học, làm bài thi, hỏi AI tutor trong một luồng duy nhất.' },
  ...
  blog: {
    ...
    cards: [
      ...
      {
        title: 'Tối ưu việc dùng AI tutor',
    ...
    primaryAction: { label: 'Vào dashboard', href: '/dashboard' },
    secondaryAction: { label: 'Mở AI tutor', href: '/ai-tutor' },
  },
  contact: {
    title: 'Liên hệ',
    summary:
  ...
  faq: {
    ...
    summary:
      'Các vấn đề phổ biến nhất khi đăng ký, truy cập dashboard, quản lý khóa học và sử dụng AI tutor.',
    tag: 'FAQ',
    updatedAt: 'Cập nhật: 22/03/2026',
    keyPoints: [
    ...
    faq: [
      ...
      {
        question: 'AI tutor có lưu lịch sử hội thoại không?',
        answer:
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          'Dữ liệu được dùng để xác thực người dùng, cá nhân hóa nội dung học, cải thiện chất lượng phản hồi AI tutor và đảm bảo ổn định hệ thống.',
